...
public class ModEvents {
    ...
    private static void modifyLootTable(LootManager lootManager, Identifier identifier, LootEvent.LootTableModificationContext lootTableModificationContext, boolean builtin) {
